...
use edvige_core::{
    Account, AccountId, Folder, FolderId, MessageDetail, MessageId, MessageSummary, SecurityMode,
};
...
pub struct AppState {
    ...
    pub selected_message_detail: Option<MessageDetail>,
    ...
    pub wizard_imap_sec: SecurityMode,
    pub wizard_smtp_host: String,
    pub wizard_smtp_port: u16,
    pub wizard_smtp_sec: SecurityMode,
...
impl Default for AppState {
    fn default() -> Self {
        Self {
            ...
            wizard_imap_sec: SecurityMode::Tls,
            wizard_smtp_host: "smtp.gmail.com".into(),
            wizard_smtp_port: 465,
            wizard_smtp_sec: SecurityMode::Tls,
